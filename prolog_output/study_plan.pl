...
% --- 'EIF201' ---
course('EIF201').
course('EIF201', 6, regular, dipl, 4, 1, 1, 'Programación I' ).
course_req('EIF201', 'EIF200').
course_req('EIF201', 'MAY230').
% --- 'MAY231' ---
course('MAY231').
course('MAY231', 7, regular, dipl, 4, 1, 1, 'Matemática para Informática II' ).
course_req('MAY231', 'MAY230').
% --- 'EstudiosGeneralesIII' ---
course('EstudiosGeneralesIII').
course('EstudiosGeneralesIII', 8, regular, dipl, 3, 1, 1, 'Estudios Generales III' ).
% --- 'EstudiosGeneralesIV' ---
course('EstudiosGeneralesIV').
course('EstudiosGeneralesIV', 9, regular, dipl, 3, 1, 1, 'Estudios Generales IV' ).
% --- 'LIX411' ---
course('LIX411').
course('LIX411', 10, regular, dipl, 4, 1, 1, 'Inglés Integrado II' ).
...
% --- 'EIF206' ---
course('EIF206').
course('EIF206', 16, regular, dipl, 4, 2, 1, 'Programación III' ).
course_req('EIF206', 'EIF204').
course_req('EIF206', 'MAY231').
% --- 'EIF207' ---
course('EIF207').
course('EIF207', 17, regular, dipl, 4, 2, 1, 'Estructuras de Datos' ).
course_req('EIF207', 'EIF203').
course_req('EIF207', 'EIF204').
% --- 'EIF205' ---
course('EIF205').
course('EIF205', 18, regular, dipl, 3, 2, 1, 'Arquitectura de Computadoras' ).
course_req('EIF205', 'EIF201').
course_req('EIF205', 'EIF202').
% --- 'EIF404' ---
course('EIF404').
course('EIF404', 19, regular, dipl, 3, 2, 1, 'La Organización y su Entorno' ).
course_req('EIF404', 'EIF201').
% --- 'MAY223' ---
course('MAY223').
course('MAY223', 20, regular, dipl, 3, 2, 1, 'Probabilidad y Estadística para Informática' ).
...
% --- 'EIF400' ---
course('EIF400').
course('EIF400', 26, regular, bsc, 4, 3, 1, 'Paradigmas de Programación' ).
course_req('EIF400', 'EIF206').
% --- 'EIF401' ---
course('EIF401').
course('EIF401', 27, regular, bsc, 4, 3, 1, 'Ingeniería de Sistemas II' ).
course_req('EIF401', 'EIF210').
% --- 'EIF402' ---
course('EIF402').
course('EIF402', 28, regular, bsc, 4, 3, 1, 'Administración de Bases de Datos' ).
course_req('EIF402', 'EIF212').
course_req('EIF402', 'EIF211').
% --- 'EIF405' ---
course('EIF405').
course('EIF405', 29, regular, bsc, 3, 3, 1, 'Investigación de Operaciones y sus Aplicaciones' ).
course_req('EIF405', 'MAY232').
course_req('EIF405', 'MAY223').
% --- 'EIF407' ---
course('EIF407').
course('EIF407', 30, regular, bsc, 3, 3, 1, 'Liderazgo y Organización ' ).
...
% --- 'EIF408' ---
course('EIF408').
course('EIF408', 36, regular, bsc, 5, 4, 1, 'Proyectos y su Aplicación en la Organización (PPS)' ).
course_req('EIF408', 'EIF209').
course_req('EIF408', 'EIF401').
course_req('EIF408', 'EIF402').
% --- 'EIF409' ---
course('EIF409').
course('EIF409', 37, regular, bsc, 4, 4, 1, 'Aplicaciones Informáticas Globales' ).
course_req('EIF409', 'EIF209').
course_req('EIF409', 'EIF401').
course_req('EIF409', 'EIF402').
% --- 'OptativaIII' ---
course('OptativaIII').
course('OptativaIII', 38, generic, bsc, 3, 4, 1, 'Optativa ' ).
% --- 'OptativaIV' ---
course('OptativaIV').
course('OptativaIV', 39, generic, bsc, 3, 4, 1, 'Optativa ' ).
% --- 'EIF410' ---
course('EIF410').
course('EIF410', 40, regular, bsc, 2, 4, 1, 'Informática y Sociedad' ).
...
course_req('EIF421O', 'EIF  207 Estructuras de Datos ').
